...
export const CLASSES: ClassData[] = [
  ...
  },
  {
    ...
    classFeatures: [
      ...
      { name: 'Ability Score Improvement', level: 8, description: 'Increase one ability score by 2, or two ability scores by 1 each. Alternatively, choose a feat.' },
      { name: 'Expertise', level: 9, description: 'Choose two more of your skill proficiencies. Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.', expertiseGrant: { count: 2 } },
  ...
  },
  {
    ...
    classFeatures: [
      ...
      { name: 'Weapon Mastery', level: 1, description: 'You have achieved a degree of mastery with weapons. Choose 2 weapons with Mastery properties to gain their Mastery benefits.' },
      { name: 'Deft Explorer', level: 2, description: 'You gain Expertise in one of your skill proficiencies. Your walking speed increases by 10 feet while you are not wearing Heavy armor.', expertiseGrant: { count: 1 } },
      { name: 'Fighting Style', level: 2, description: 'You adopt a particular style of fighting as your specialty. Choose a Fighting Style feat.' },
  ...
  },
  {
    ...
    classFeatures: [
      { name: 'Expertise', level: 1, description: 'Choose two of your skill proficiencies. Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.', expertiseGrant: { count: 2 } },
      ...
      { name: 'Expertise', level: 6, description: 'Choose two more of your skill proficiencies or one skill proficiency and your proficiency with Thieves\' Tools. Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.', expertiseGrant: { count: 2 } },
      { name: 'Evasion', level: 7, description: 'When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.' },
    ...
    subclasses: [
      {
        ...
        features: [
          { name: 'Psionic Spells', level: 3, description: 'When you reach a Sorcerer level specified in the Psionic Spells table, you thereafter always have the listed spells prepared. Level 3: Arms of Hadar, Calm Emotions, Detect Thoughts, Dissonant Whispers. Level 5: Hunger of Hadar, Sending. Level 7: Evard\'s Black Tentacles, Summon Aberration. Level 9: Rary\'s Telepathic Bond, Telekinesis.' },
          { name: 'Telepathic Speech', level: 3, description: 'You can form a telepathic connection between your mind and the mind of another. As a Bonus Action, choose one creature you can see within 30 feet of yourself. You and the chosen creature can communicate telepathically with each other while the two of you are within a number of miles of each other equal to your Charisma modifier (minimum 1 mile). To understand each other, you each must mentally use a language the other knows. The telepathic connection lasts for a number of minutes equal to your Sorcerer level. It ends early if you use this feature to connect with a different creature.' },
          { name: 'Psionic Sorcery', level: 6, description: 'When you cast any 1st-level spell or higher from your Psionic Spells feature, you can cast it by expending a spell slot as normal or by spending a number of Sorcery Points equal to the spell\'s level. If you cast the spell using Sorcery Points, it requires no Verbal or Somatic components, and it requires no Material components unless they are consumed by the spell or have a cost specified in it.' },
          { name: 'Psychic Defenses', level: 6, description: 'You gain Resistance to Psychic damage. Moreover, you have Advantage on saving throws against the Charmed and Frightened conditions.' },
          { name: 'Revelation in Flesh', level: 14, description: 'You can unleash the aberrant truth hidden within yourself. As a Bonus Action, you can spend 1 or more Sorcery Points to magically alter your body for 10 minutes. For each Sorcery Point you spend, you gain one of the following benefits (choose each time you spend a point): Aquatic Adaptation (gain a Swim Speed equal to twice your Speed, and you can breathe underwater), Glistening Flight (gain a Fly Speed equal to your Speed, and you can hover), See the Invisible (you see any Invisible creature within 60 feet that isn\'t behind Total Cover), Wormlike Movement (your body and equipment become slimy and pliable; you can move through any space as narrow as 1 inch, and you don\'t provoke Opportunity Attacks).' },
          { name: 'Warping Implosion', level: 18, description: 'You can unleash your aberrant power as a space-warping anomaly. As a Magic action, you teleport to an unoccupied space you can see within 120 feet of yourself. Immediately after you disappear, each creature within 30 feet of the space you left must make a Strength saving throw against your spell save DC. On a failed save, the creature takes 3d10 Force damage and is pulled straight toward the space you left, ending in an unoccupied space as close to your former space as possible. On a successful save, the creature takes half as much damage only. Once you use this feature, you can\'t do so again until you finish a Long Rest unless you spend 5 Sorcery Points (no action required) to restore your use of it.' },
        ],
      },
      {
        ...
        features: [
          { name: 'Clockwork Magic', level: 3, description: 'When you reach a Sorcerer level specified in the Clockwork Spells table, you thereafter always have the listed spells prepared. Level 3: Aid, Alarm, Lesser Restoration, Protection from Evil and Good. Level 5: Dispel Magic, Protection from Energy. Level 7: Freedom of Movement, Summon Construct. Level 9: Greater Restoration, Wall of Force. Whenever you gain a Sorcerer level, you can replace one spell from this feature with another Abjuration or Transmutation spell of the same level from the Sorcerer, Warlock, or Wizard spell list.' },
          { name: 'Restore Balance', level: 3, description: 'Your connection to the plane of absolute order allows you to equalize chaotic moments. When a creature you can see within 60 feet of yourself is about to roll a d20 with Advantage or Disadvantage, you can take a Reaction to prevent the roll from being affected by Advantage and Disadvantage. You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a Long Rest.' },
          { name: 'Bastion of Law', level: 6, description: 'You can tap into the grand equation of existence to imbue a creature with a shimmering shield of order. As a Magic action, you can expend 1 to 5 Sorcery Points to create a magical ward around yourself or another creature you can see within 30 feet. The ward is represented by a number of d8s equal to the number of Sorcery Points spent. When the warded creature takes damage, it can expend a number of those dice, roll them, and reduce the damage taken by the total rolled on those dice. The ward lasts until you finish a Long Rest or until you use this feature again.' },
          { name: 'Trance of Order', level: 14, description: 'You gain the ability to align your consciousness to the endless calculations of Mechanus. As a Bonus Action, you can enter this state for 1 minute. For the duration, attack rolls against you can\'t benefit from Advantage, and whenever you make a d20 Test, you can treat a roll of 9 or lower as a 10. Once you use this feature, you can\'t use it again until you finish a Long Rest unless you spend 5 Sorcery Points (no action required) to restore your use of it.' },
          { name: 'Clockwork Cavalcade', level: 18, description: 'You summon spirits of order to expunge disorder around you. As a Magic action, you summon the spirits in a 30-foot Cube originating from you. The spirits look like modrons or other constructs of your choice. The spirits are intangible and invulnerable, and they create the following effects within the Cube before vanishing. Restore: The spirits restore up to 100 Hit Points, divided as you choose among any number of creatures of your choice in the Cube. Repair: Any damaged objects entirely in the Cube are repaired instantly. Dispel: Every spell of 6th level or lower ends on creatures and objects of your choice in the Cube. Once you use this feature, you can\'t use it again until you finish a Long Rest unless you spend 7 Sorcery Points (no action required) to restore your use of it.' },
        ],
      },
      {
      ...
      },
      {
        ...
        description: 'Your innate magic comes from the wild forces of chaos that underlie the order of creation. You might have endured exposure to some form of raw magic, perhaps through a planar portal leading to Limbo or the Far Realm, or have a touch of fey magic.',
        features: [
          { name: 'Wild Magic Surge', level: 3, description: 'Your spellcasting can unleash surges of untamed magic. Once per turn, roll 1d20 immediately after you cast a Sorcerer spell with a spell slot. If you roll a 20, roll on the Wild Magic Surge table to create a magical effect. If the effect is a spell, it is too wild to be affected by your Metamagic, and if it normally requires Concentration, it doesn\'t require Concentration in this case; the spell lasts for its full duration.' },
          { name: 'Tides of Chaos', level: 3, description: 'You can manipulate the forces of chance and chaos. When you make a d20 Test, you can give yourself Advantage on the roll. Once you do so, you must cast a Sorcerer spell with a spell slot or finish a Long Rest before you can use this feature again. When you cast the spell, roll 1d20. If you roll 20 or less, a Wild Magic Surge occurs.' },
          { name: 'Bend Luck', level: 6, description: 'You have the ability to twist fate using your wild magic. When another creature you can see makes a d20 Test, you can take a Reaction and spend 2 Sorcery Points to roll 1d4 and apply the number rolled as a bonus or penalty (your choice) to the creature\'s roll. You can do so after the creature rolls but before any effects of the roll occur.' },
          { name: 'Controlled Chaos', level: 14, description: 'You gain a modicum of control over the surges of your wild magic. Whenever you roll on the Wild Magic Surge table, you can roll twice and use either number.' },
          { name: 'Spell Bombardment', level: 18, description: 'The harmful energy of your spells intensifies. When you roll damage for a spell and roll the highest number possible on any of the dice, you can roll that die again and add that roll to the damage. You can use this feature only once per turn.' },
        ],
      },
    ],
    startingEquipment: [
  ...
  },
  {
    ...
    subclasses: [
      {
        name: 'Archfey Patron',
        description: 'Your pact draws on the power of the Feywild, the mysterious realm of the fey. Your patron might be a legendary creature, such as a Fey queen or prince, or perhaps a powerful hag. Whatever the source, the magic bestowed on you beguiles and charms both friends and foes.',
        features: [
          { name: 'Patron Spells', level: 3, description: 'You always have certain spells prepared. Level 3: Calm Emotions, Faerie Fire, Misty Step, Sleep. Level 5: Blink, Plant Growth. Level 7: Dominate Beast, Greater Invisibility. Level 9: Dominate Person, Seeming.' },
          { name: 'Fey Presence', level: 3, description: 'Your patron grants you the ability to project the beguiling and fearsome presence of the fey. As a Magic action, you can cause each creature in a 10-foot Cube originating from you to make a Wisdom saving throw against your spell save DC. The creatures that fail the save are all Charmed or Frightened by you (your choice) until the end of your next turn. Once you use this feature, you can\'t use it again until you finish a Short or Long Rest.' },
          { name: 'Misty Escape', level: 6, description: 'You can vanish in a puff of mist in response to harm. When you take damage, you can take a Reaction to turn Invisible and teleport up to 60 feet to an unoccupied space you can see. You remain Invisible until the start of your next turn or until you attack, cast a spell, or force a creature to make a saving throw. Once you use this feature, you can\'t use it again until you finish a Short or Long Rest.' },
      ...
      },
      {
        ...
        features: [
          { name: 'Patron Spells', level: 3, description: 'You always have certain spells prepared. Level 3: Cure Wounds, Guiding Bolt, Lesser Restoration, Light. Level 5: Daylight, Revivify. Level 7: Guardian of Faith, Wall of Fire. Level 9: Greater Restoration, Summon Celestial.' },
          { name: 'Healing Light', level: 3, description: 'You gain the ability to channel celestial energy to heal wounds. You have a pool of d6s that you spend to fuel this healing. The number of dice in the pool equals 1 + your Warlock level. As a Bonus Action, you can heal one creature you can see within 60 feet of yourself, spending dice from the pool. The maximum number of dice you can spend at once equals your Charisma modifier (minimum of one die). Roll the dice you spend, add them together, and restore a number of Hit Points equal to the total. Your pool regains all expended dice when you finish a Long Rest.' },
      ...
      {
        name: 'Fiend Patron',
        description: 'Your patron is a fiendish being of the Lower Planes. You might have made a deal with a demon, a devil, or some other powerful fiend. The pact grants you the ability to draw on dark power and summon fiendish servants, but be warned: such power always comes at a price.',
        features: [
          { name: 'Patron Spells', level: 3, description: 'You always have certain spells prepared. Level 3: Burning Hands, Command, Scorching Ray, Suggestion. Level 5: Fireball, Stinking Cloud. Level 7: Fire Shield, Wall of Fire. Level 9: Geas, Insect Plague.' },
          { name: 'Dark One\'s Blessing', level: 3, description: 'When you reduce a Hostile creature to 0 Hit Points, you gain Temporary Hit Points equal to your Charisma modifier plus your Warlock level (minimum of 1 Temporary Hit Point).' },
          { name: 'Dark One\'s Own Luck', level: 6, description: 'You can call on your patron to alter fate in your favor. When you make an ability check or a saving throw, you can add 1d10 to the roll. You can do so after seeing the roll but before any of its effects occur. Once you use this feature, you can\'t use it again until you finish a Short or Long Rest.' },
      ...
      },
      {
        ...
        features: [
          { name: 'Patron Spells', level: 3, description: 'You always have certain spells prepared. Level 3: Detect Thoughts, Dissonant Whispers, Phantasmal Force, Tasha\'s Hideous Laughter. Level 5: Clairvoyance, Hunger of Hadar. Level 7: Confusion, Summon Aberration. Level 9: Modify Memory, Telekinesis.' },
          { name: 'Awakened Mind', level: 3, description: 'Your alien knowledge gives you the ability to touch the minds of other creatures. You can telepathically speak to any creature you can see within 30 feet of yourself. When you do so, you speak mentally in a language you know, and the creature understands you only if it knows that language. Your communication doesn\'t give the creature the ability to respond to you telepathically.' },
  ...
  },
  {
    ...
    classFeatures: [
      ...
      { name: 'Scholar', level: 2, description: 'You gain Expertise in one of the following skills: Arcana, History, Investigation, Medicine, Nature, or Religion.', expertiseGrant: { count: 1, skills: ['arcana', 'history', 'investigation', 'medicine', 'nature', 'religion'] } },
